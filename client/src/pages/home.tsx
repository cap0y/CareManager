...
const Home = () => {
  ...
  const handleBookingClick = async (manager: CareManager) => {
    ...
    const firstServiceName =
      (manager.services as any[]).length > 0
        ? typeof (manager.services as any[])[0] === "string"
          ? (manager.services as any[])[0]
          : (manager.services as any[])[0].name
        : "";
    setBookingModal({
      isOpen: true,
      manager,
  ...
  const popularCareManagers = [...careManagers]
    .sort((a, b) => b.reviews - a.reviews)
    .slice(0, 8);

  // 추천 케어 매니저 (평점이 높은 순)
  const recommendedCareManagers = [...careManagers]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 pb-2">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          <div className="text-center">
            ...
            <p
              className="text-lg sm:text-xl text-white/90 mb-6 max-w-3xl mx-auto animate-fade-in"
            ...
            {/* Mobile Search */}
            <div
              className="sm:hidden mb-6 px-4 animate-fade-in"
            ...
            >
              ...
              <div className="mt-3">
                <Button
                  className="w-full gradient-purple text-white rounded-xl py-2"
            ...
            {/* Desktop Search */}
            <div
              className="hidden sm:block max-w-2xl mx-auto animate-fade-in"
              style={{ animationDelay: "0.4s" }}
            >
            ...
            {services.map((service) => (
              ...
              >
                <CardContent className="p-4 text-center">
                  <div
                    className={`${service.color} w-14 h-14 flex items-center justify-center rounded-full mx-auto mb-2`}
                  >
      ...
      {/* 추천 케어 매니저 수평 슬라이드 */}
      <section className="pt-6 pb-6 sm:pt-8 sm:pb-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-sm">
                ...
                {notices.slice(0, 5).map((notice) => (
                  <div
                    ...
                    onClick={() => {
                      console.log(
                        `공지사항 클릭: ID ${notice.id}, 제목 ${notice.title}`,
                      );
