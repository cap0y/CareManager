            ...
            {services.map((service) => (
              ...
              >
                <CardContent className="p-4 text-center">
                  <div className={`${service.color} w-14 h-14 flex items-center justify-center rounded-full mx-auto mb-2`}>
                    <i className={`${service.icon} text-2xl`}></i>
                  </div>
                  <h3 className="text-lg font-bold text-gray-800 mb-0.5">{service.name}</h3>
